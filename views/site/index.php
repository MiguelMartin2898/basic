...
<div class="site-index">
    ...
    <img src="../hola.jpg" alt="hola.jpg" class="img-thumbnail">
...
<ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
  ...
  <li><a href="#">Holi</a></li>
  <li><a href="#">hambre</a></li>
 </ul> 
 </div>
 <div class="btn-group" role="group" aria-label="...">
  <button type="button" class="btn btn-default">ventas</button>
  <button type="button" class="btn btn-default">comprass</button>
...
<nav>
  <ul class="pager">
    <li class="previous"><a href="#"><span aria-hidden="true">&larr;</span> Antes</a></li>
    <li class="next"><a href="#">Despues <span aria-hidden="true">&rarr;</span></a></li>
  </ul>
</nav>
